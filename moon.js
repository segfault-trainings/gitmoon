...
function setup() {
    ...
    var spaceMaterial = new THREE.MeshPhongMaterial({
      map: ctx.textureLoader.load("assets/images/space.png"),
...
function Moon(color) {
    ...
    // load moon textures
    let moonTexture = ctx.textureLoader.load("assets/images/moon.jpg");
    let moonDisplacementMap = ctx.textureLoader.load("assets/images/moon_displacement.jpg");
